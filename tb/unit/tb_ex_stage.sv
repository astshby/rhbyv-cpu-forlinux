// Module: tb_ex_stage
// Description: Checks MDU operand capture, EX backpressure, cancellation, and exception pass-through.
module tb_ex_stage;
    timeunit 1ns;
    timeprecision 1ps;
    ...
    initial begin
        ...
        for (int cycles = 0; !out_packet.valid; cycles++) begin
        ...
        repeat (3) begin
            assert (!execution_stall && out_packet.result == xlen_t'(21) &&
